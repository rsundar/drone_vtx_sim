...
from drone_vtx_sim.sweeps import run_ber_sweep


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run a Drone VTX BER/PER sweep.")
    parser.add_argument("--channel", choices=["awgn", "rayleigh", "rician", "tdl"], default="awgn")
    ...
    parser.add_argument("--snr-step-db", type=float, default=2.0)
